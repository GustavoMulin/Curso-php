...
do nosso código. No entanto, a validação de formulário
não é o unico processo em que é necessário validar dados.

Por exemplo, podemos estar a carregar informação a partir
de um ficheiro de dados, ou de uma base de dados, e podemos
ter a necesidade de analisar, por exemplo, se um email é válido,
...
echo '<br>';
var_dump((is_string($valor2)));     // boll(false)
echo '<hr>';
...
$valor3 = 13.5;
$valor4 = true;
var_dump(is_numeric($valor1));      // boll(false)
echo '<br>';
var_dump(is_numeric($valor2));      // boll(true)
echo '<br>';
var_dump(is_numeric($valor3));      // boll(true)
echo '<br>';
var_dump(is_numeric($valor4));      // boll(false)
echo '<hr>';
...
var_dump(is_bool($valor1));     // boll(false)
echo '<br>';
var_dump(is_bool($valor1));     // boll(true)
echo '<br>';
var_dump(is_bool($valor1));     // boll(false)
echo '<hr>';
...
$valor4 = 1;
$valor5 = [];
var_dump(empty($valor1));       // boll(false)
echo '<br>';
var_dump(empty($valor1));       // boll(true)
echo '<br>';
var_dump(empty($valor1));       // boll(true)
echo '<br>';
var_dump(empty($valor1));       // boll(false)
