...
<body class="bg-dark">
                ...
                <form action="submissao.php" method="post" name="formulario">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <!-- radiobuttons -->
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" id="radio_1" checked value="opção 1">
                                <label for="radio_1" class="form-check-label">Opção 1</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" id="radio_2" value="opção 2">
                                <label for="radio_2" class="form-check-label">Opção 2</label>
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="radio" id="radio_3" value="opção 3">
    ...
    <script>
        document.querySelector("#preencher").addEventListener('click', () => {
            ...
            formulario['text_texto'].value = "Gustavo"
            formulario['text_password'].value = "12345"
